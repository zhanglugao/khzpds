...
$("<a href=\"javascript:void(0)\" class=\"datebox-clean\"></a>").html(_4.cleanText).appendTo(_9);
...
_9.find(".datebox-clean").click(function(){
$(_9).combo("setValue","").combo("setText","");//设置空值
$(_9).combo("hidePanel");//点击清空按钮之后关闭日期选择面板
});
};
};
function _a(_b,q){
...
_a(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",formatter:function(_1d){
