...
<jsp:include page="../common/open_inc.jsp"></jsp:include>></script>
                             ...
                             <li>
                              ...
                              <li>
                                <label  class="ml50">（请在相应的类别中打√）</label>
                                    <input name="lb"   type="checkbox"  value="1"   /><label >大学段</label>
                                    <input name="lb"   type="checkbox"  value="2" />  <label >社会人士</label>
                        ...
                        <ul class="right-form">
                         ...
                         <ul class="cb left-form ml30">
                            ...
                            <li>
                             ...
                             <li>
                                <span>主演</span>
                                <textarea cols="96" rows="2" ></textarea>
                             ...
                             <li>   
                               <textarea cols="100" rows="10" class="ml100"></textarea>
