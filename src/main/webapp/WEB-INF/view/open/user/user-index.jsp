		...
		$.ajax({
			...
			success:function(data){
				...
				for(var i=0;i<list.length;i++){
					var obj=list[i];
					var html="<tr class='trclass'><td class='zp1'>"+obj.productionName+"</td><td class='ss1'>"+obj.competitionType+"</td><td class='ts1'>"+obj.createTime+
						"</td><td class='zt1'>"+obj.applyStatus+"</td>";
					if(obj.applyStatus=='已报名'){
						html+="<td class='cz1'><a onclick='cancelApply(\""+obj.id+"\")' href='javascript:;'>撤销</a></td></tr>";
					}else if(obj.applyStatus=='已取消'){
						html+="<td class='cz1'><a onclick='toedit(\""+obj.id+"\")' href='javascript:;'>编辑</a></td></tr>";
					}
					$("#dataDiv").append(html);
